    ...
    <div class="pt-3">
        <form action="/jabatan/store" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= session('errors')['nama_jabatan'] ?? false ? 'is-invalid' : '' ?>" name="nama_jabatan" value="<?= old('nama_jabatan'); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= session('errors')['deskripsi_jabatan'] ?? false ? 'is-invalid' : '' ?>" name="deskripsi_jabatan" value="<?= old('deskripsi_jabatan'); ?>">
                <div class="invalid-feedback">
